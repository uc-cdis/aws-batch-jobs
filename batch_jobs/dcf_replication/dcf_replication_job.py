...
def run_job(
    ...
    logging.info(
        f"Submission Job started at {datetime.datetime.now()} with {NUMBER_OF_THREADS} threads and {MAX_RETRIES} retries."
    )
    ...
    logging.info(f"Job ending time is {datetime.datetime.now()}")
